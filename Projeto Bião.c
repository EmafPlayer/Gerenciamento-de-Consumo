...
float contrato(float preco)
{                                          // Função para o contrato mensal
...
int main(void)
{
  ...
  while (saida != 0)
  {
        ...
        case 2:
          ...
          case 3:
            ...
            if (opcao == 1)
            {
              ...
              scanf("%s", fp);
              printf("\nPedido Finalizado\n");
              fprintf(arquivo, "Combo_tradicional:_2_Pizzas_Grandes_+_Refrigerante_1L 61.99\n");
              fclose(arquivo);
            }
            else
            {
              ...
              scanf("%s", fp);
              printf("\nPedido Finalizado\n");
              fprintf(arquivo, "Combo_tradicional:_2_Pizzas_Grandes_+_Refrigerante_1L %0.2f\n", precof);
              fclose(arquivo);
            }
            break;
    ...
    case 2:
      ...
      while (fscanf(arquivo, "%s %f", produto, &valor) != EOF)
      { // procurar os dados do arquivo, enquanto ele n chegar ao fim
        a++;
